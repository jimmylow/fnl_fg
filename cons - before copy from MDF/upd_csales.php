...
function getbal (str) {
  ...
  var endbal = opening + begbal + doqty - soldqty - rtnqty - shortqty + overqty + adjqty;
	 ...
	 <legend class="title">UPDATE COUNTER SALES ENTRY</legend>
      ...
      <?php if($var_less == "N") { echo "readonly disable =''"; } ?>>		   
        ...
        <input name="procotype[]" class="tInput" id="procotype<?php echo $i; ?>" style="width: 48px;" value ="<?php echo $rowq['sptype']; ?>"></td>                
                <td>
				<input name="opening[]" id="opening<?php echo $i; ?>" style="width: 48px; text-align : right" value ="<?php echo $rowq['openingqty']; ?>" ></td>
                <td>
				<input name="procodoqty[]" id="procodoqty<?php echo $i; ?>" style="width: 48px; text-align : right" value ="<?php echo $rowq['doqty']; ?>" readonly></td>
        ...
        <input name="procotype[]" class="tInput" id="procotype<?php echo $i; ?>" style="width: 48px;" value ="<?php echo $rowq['sptype']; ?>"></td>                
				...
				<input name="opening[]" id="opening<?php echo $i; ?>" style="width: 48px; text-align : right" value ="<?php echo $rowq['openingqty']; ?>" ></td>
                <td>
				<input name="procodoqty[]" id="procodoqty<?php echo $i; ?>" style="border-style: none; width: 48px; text-align : right" value ="<?php echo $rowq['doqty']; ?>" ></td>

...
{
    var vadjqtyid = "issueqtyid"+vid;
    	
    var col1 = document.getElementById(vadjqtyid).value;
	...
	if (col1 != ""){
    	...
    	document.getElementById(vadjqtyid).value = parseFloat(col1).toFixed(2);
    }
...
function caltotmscb()
{
        ...
        for (var i=0;i<fields.length;i++){
              if( fields[i].getAttribute('tMark') != "1" ) continue;//adj any field not carring the "sumMe" attribute
         ...
         var totSpre = 0;
         for (var i=0;i<fields.length;i++){
              if( fields[i].getAttribute('tSpre') != "1" ) continue;//adj any field not carring the "sumMe" attribute
			  var txt = fields[i].value;
		  ...
		  var totCut = 0;
          for (var i=0;i<fields.length;i++){
              if( fields[i].getAttribute('tCut') != "1" ) continue;//adj any field not carring the "sumMe" attribute
			  var txt = fields[i].value;
		  ...
		  var totBund = 0;
          for (var i=0;i<fields.length;i++){
              if( fields[i].getAttribute('tBund') != "1" ) continue;//adj any field not carring the "sumMe" attribute
			  var txt = fields[i].value;
		  ...
		  <table id="itemsTable" class="general-table" style="width: 841px">
            ...
            <tbody>
             ...
             <tr class="item-row">
				...
				<td>
				<input name="issueqty[]" value="0" class="tInput" id="issueqtyid1" onBlur="calcCost('1');" style="width: 75px"></td>  
             </tr>
            </tbody>
           </table>
